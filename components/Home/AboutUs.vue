<template>
  <section class="about-us">
    <div class="row p-4">
      ...
      <div class="col-6">
        <img class="float-lg-right" src="~/assets/brandy.jpg" alt="home-img" title="home-img" loading="lazy" style="width: 650px; height: auto;">
      </div>
      <div class="col-12 col-sm-6">
        <h2 style="font-family: avenir-heavy; color: #7D2248;">About Kavess</h2>
    ...
    <div class="row p-4">
      ...
      <div class="col-6">
        <img src="~/assets/bot.jpg" alt="home-img-2" title="home-img-2" loading="lazy" style="width: 650px; height: auto;">
      </div>
    </div>
  </section>
</template>
